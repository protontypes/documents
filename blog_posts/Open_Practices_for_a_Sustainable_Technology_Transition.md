...
<!-- Feedback J.:
  [X] The article assumes a few things, regarding "open principles". 
  [ ] Maybe go into it minimally in the first paragraph (one sentence) + link with more information.
  [x] Title is cryptic
  [x] Partly the reference to sustainability is missed
  [x] explain more what the RISC-V example is about
  [x] from the headings it is expected that it is the open principles, what are the principles now?
  [ ] The transition sentence in "Knowledge Evolution and Adaptation" is confusing. Are we now continuing to talk about TnT? Is that equated with sustainability?
  [x] Examples are important, and always make the connection to the principles (one is missing in "Collaborative Innovation"!).
  [ ] The end comes abruptly, maybe a heading to delineate that.
  [ ] Suggested title: "Why open principles boost sustainability transition" / "Why sustainability transition benefits from open principles"
-->
